...
Version 0.2 is available in [F-Droid](https://f-droid.org/repository/browse/?fdid=com.quaap.launchtime), but it has some bugs.  If you'd like to test 0.3 before it is released, go [here](https://github.com/quaap/LaunchTime/releases/tag/b0.3.beta1).
